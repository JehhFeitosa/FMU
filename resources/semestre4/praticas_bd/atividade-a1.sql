...
DECLARE @INICIO INT = 1, @FINAL INT = 3000, @FIM INT = 30000, @QTD_MULHERES INT, @QTD_HOMENS INT;

-- CRIA UM LOOP PARA NAVEGAR PELA TABELA
WHILE(@INICIO <= @FIM)
	BEGIN
...
-- APRESESENTA NA TELA A TABELA RELACAO
SELECT * FROM RELACAO;
